  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl font-light tracking-wider mb-16 text-gray-900">OUR PORTFOLIO</h2>
            ...
            <div key={index} className="portfolio-item group cursor-pointer">
              <div className="relative h-[500px] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-end">
                  <h3 className="text-white text-xl font-light tracking-wider p-8">{item.title}</h3>
                </div>
              </div>
            </div>
          ))}
